export async function GET() {
  const tickets = [
    ...
    },
    {
      ...
      status: 'In Progress',
      assignee: 'Jordan',
      updatedAt: '2025-10-30T13:12:00Z'
    },
    {
      id: 't-1003',
    ...
    },
    {
      ...
      description: 'Stuck in onboarding awaiting software licenses.',
      priority: 'Critical',
      status: 'Open',
      assignee: 'Morgan',
    ...
    },
    {
      ...
      description: 'Packet loss and retries during meetings.',
      priority: 'Medium',
      status: 'Open',
      assignee: 'Unassigned',
    ...
    },
    {
      ...
      description: 'Password reset not working for the user.',
      priority: 'High',
      status: 'Resolved',
      assignee: 'Sam',
    ...
    {
      id: 't-1016',
      title: 'Broken HDMI in Huddle Room 2',
      description: 'Cable frayed; no signal.',
      priority: 'Medium',
      status: 'Open',
      assignee: 'Facilities',
